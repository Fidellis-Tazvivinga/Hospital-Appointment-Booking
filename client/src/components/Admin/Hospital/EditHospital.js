...
import { createHospital, editHospitalApi, getEachHospitalApi } from "../../../api/hospital";
...
const EditHospital = () => {
    ...
    const editHospital = async (id) => {

        //get the clinic
        const hospitalId = id
        const res = await getEachHospitalApi(hospitalId)
    ...
    const handleSubmit = (evt) => {
        ...
        if (
            ...
            //send data to server
            editHospitalApi(hospitalId, formData)
                .then((response) => {
    ...
    const showSignupForm = () => (
        <div className="row">
            <div className="col-10 mx-auto">
                <img className="server__images" src={`/uploads/${hospitalImage && hospitalImage}`} alt="hello" />
                <form id="formCreateNewHospital" onSubmit={handleSubmit} >
                    <div className="form-row">
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <input type="text" className="form-control" id="phone" name="hospitalPhoneNumber" value={hospitalPhoneNumber}
                                onChange={handleHospitalChange} placeholder="Phone number" />
                        </div>
                    </div>
                    ...
                    <button type="submit" className="btn btn-primary" id="createNewHospital">Update</button>
                </form>
            </div>
        </div >
        ...
        <div>
            <MainDashboardLayout>
                <div className="container" >
                    <Link to="/admin/hospitals">View hospital</Link>
                </div>
                <div className="">
                    <div className="">
                        <div className="">
