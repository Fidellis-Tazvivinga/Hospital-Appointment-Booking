                            ...
                            <TabPane tab="Hospital" key="1">
                                <List
                                    ...
                                    renderItem={item =>
                                        ...
                                        <Link to="/user/appointment/clinic" state={{ doctor: item.name, doctorId: item._id, appointmentPlace: item.clinic?.clinicName, clinicId: item.clinic?._id, specialization: item.specialization?.name }}>
                                            <List.Item>
