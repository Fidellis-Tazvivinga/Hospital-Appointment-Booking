...
import { getClinicByProvinceApi } from '../../../../api/clinic';
import { getDoctorsBySearch } from '../../../../api/doctor';

const { Option } = Select;

const VaccSearchHosp = ({ vaccinePlace, setClinicVisible, vaccineName, visibleClinic }) => {
    ...
    const [optionValueSpecialization, setOptionValueSpecialization] = useState(vaccineName)
    ...
    return (
        <>
            ...
            <Modal
                ...
                onOk={() => setClinicVisible(false)}
                onCancel={() => setClinicVisible(false)}
                width={750}
                footer={null}
